...
const CANVAS_COLOR_FALLBACKS = {
  light: {
    ...
    "--speed-high": "#e07a35",
    "--speed-max": "#d6463d",
    "--speed-up-idle": "#3aa76a",
    "--speed-up-low": "#d9992b",
    "--speed-up-high": "#e07a35",
    "--speed-up-max": "#d6463d",
    "--speed-down-idle": "#3aa76a",
    "--speed-down-low": "#d9992b",
    "--speed-down-high": "#e07a35",
    "--speed-down-max": "#d6463d",
  ...
  dark: {
    ...
    "--speed-high": "#ef8f55",
    "--speed-max": "#ec6a5e",
    "--speed-up-idle": "#61c08f",
    "--speed-up-low": "#e0b34f",
    "--speed-up-high": "#ef8f55",
    "--speed-up-max": "#ec6a5e",
    "--speed-down-idle": "#61c08f",
    "--speed-down-low": "#e0b34f",
    "--speed-down-high": "#ef8f55",
    "--speed-down-max": "#ec6a5e",
