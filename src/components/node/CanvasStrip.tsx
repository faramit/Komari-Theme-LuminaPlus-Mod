...
const CANVAS_COLOR_FALLBACKS = {
  light: {
    "--progress-bg": "#e4e4e7",
    "--progress-cpu": "#004f73",
    "--progress-memory": "#004f73",
    "--progress-disk": "#004f73",
    "--progress-network": "#004f73",
    "--progress-load": "#004f73",
    "--speed-idle": "#004f73",
    "--speed-low": "#004f73",
    "--speed-high": "#004f73",
    "--speed-max": "#004f73",
    "--speed-up-idle": "#004f73",
    "--speed-up-low": "#004f73",
    "--speed-up-high": "#004f73",
    "--speed-up-max": "#004f73",
    "--speed-down-idle": "#004f73",
    "--speed-down-low": "#004f73",
    "--speed-down-high": "#004f73",
    "--speed-down-max": "#004f73",
  ...
  dark: {
    "--progress-bg": "#26262a",
    "--progress-cpu": "#ffe6cb",
    "--progress-memory": "#ffe6cb",
    "--progress-disk": "#ffe6cb",
    "--progress-network": "#ffe6cb",
    "--progress-load": "#ffe6cb",
    "--speed-idle": "#ffe6cb",
    "--speed-low": "#ffe6cb",
    "--speed-high": "#ffe6cb",
    "--speed-max": "#ffe6cb",
    "--speed-up-idle": "#ffe6cb",
    "--speed-up-low": "#ffe6cb",
    "--speed-up-high": "#ffe6cb",
    "--speed-up-max": "#ffe6cb",
    "--speed-down-idle": "#ffe6cb",
    "--speed-down-low": "#ffe6cb",
    "--speed-down-high": "#ffe6cb",
    "--speed-down-max": "#ffe6cb",
